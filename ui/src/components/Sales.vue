          ...
          <v-card-text class="pa-6">
            <v-list>
              ...
              <v-list-item>
                ...
                <v-list-item-subtitle>
                  You can also type product codes manually and press Enter to
                  add them.
                </v-list-item-subtitle>
              </v-list-item>
              ...
              <v-list-item>
                ...
                <v-list-item-subtitle>
                  If a product isn't found, check that the outlet is selected
                  and the product exists in the system.
                </v-list-item-subtitle>
              </v-list-item>
            </v-list>
          </v-card-text>
